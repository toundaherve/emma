...
const CTABanner = () => {
  return (
    <div class="cta-banner">
      <div class="masthead">
        <div class="masthead-container masthead-cta-banner">
          <picture>
            {/*<!--[if IE 9]>*/}
            ...
            {/*<![endif]--> */}
            <img
              class="background-image-blur image-cover masthead-image b-lazy unblur b-loaded"
          ...
          <div class="banner-content cta-banner-content bg-overlay-light">
            ...
            <div class="btn-container center cta-component">
              <a class="btn" id="home-7-button-1" href="/delivery">
                Learn about Delivery
              </a>
              <a class="btn inverse" id="home-7-button-2" href="/curbside">
